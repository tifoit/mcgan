...
parser.add_argument('--old_model', dest='old_model', help='the path to the old model', default='../models/shoes_64.mcgan_', type=str)
...
if not args.new_model:
    args.new_model = args.old_model.replace('.mcgan_', '_new.mcgan_')  # new
